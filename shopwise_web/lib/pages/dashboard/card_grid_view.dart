...
class CardGridView extends StatelessWidget {
  ...
  Map detailsDict = {
    ...
    2: {
      ...
      "cardColor": const Color.fromARGB(255, 246, 186, 182),
    },
    3: {
      "title": "100",
      "subtitle": "Total Categories",
      "icon": Icons.category,
      "cardColor": const Color.fromARGB(255, 152, 239, 155),
    },
  };
        ...
        return Card(
          ...
          child: Center(
            child: ListTile(
              ...
              subtitle: Text(detailsDict[index]["title"],style: const TextStyle(fontSize: 20),),
              title: Text(detailsDict[index]["subtitle"],style: const TextStyle(fontSize: 15),),
            ),
          ),
        );
      },
